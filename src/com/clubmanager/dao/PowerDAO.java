...
import com.clubmanager.bean.Power;
 ...
 * 
 * @see com.clubmanager.bean.Power
 * @author MyEclipse Persistence Tools
 */
public class PowerDAO extends HibernateDaoSupport {
	...
	public Power findById(java.lang.Integer id) {
		...
		try {
			Power instance = (Power) getHibernateTemplate().get(
					"com.clubmanager.bean.Power", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByPowername(Object powername) {
		return findByProperty(POWERNAME, powername);
	}
	...
	public Power merge(Power detachedInstance) {
		...
		try {
			Power result = (Power) getHibernateTemplate().merge(
					detachedInstance);
	...
	public static PowerDAO getFromApplicationContext(ApplicationContext ctx) {
		return (PowerDAO) ctx.getBean("PowerDAO");
	}
}